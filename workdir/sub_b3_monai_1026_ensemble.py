...
def main():
    ...
    monai_models = [
        ...
        monaimodel.MonaiModelTest("output_jan/5foldmonai/monai3d_160_3ch_1e-5_20ep_aug_6targets_3_0.2802949547767639(1).pth"),   # fold3
    ]
    ...
    img_models = {
        ...
        "fold3:b3_non_weight": [get_model_eval(ImgModel(archi="tf_efficientnet_b3_ns", pretrained=False), "output_yuji/b3_non_weight/fold3_ep0.pt"), 7.480972390526775],
    }
